...
func koreanTranslationSet() TranslationSet {
	return TranslationSet{
		...
		ToggleSelectionForPatch:             `라인(들)을 패치에 추가/삭제`,
		TogglePanel:                         `패널 전환`,
		...
		ViewMergeRebaseOptions:              "병합/리베이스 옵션 보기",
		NotMergingOrRebasing:                "현재 병합/리베이스 중이지 않습니다.",
		RecentRepos:                         "최근에 사용한 저장소",
		MergeOptionsTitle:                   "병합 옵션",
		RebaseOptionsTitle:                  "리베이스 옵션",
		...
		LcViewBulkSubmoduleOptions:          "서브모듈 일괄 옵션 보기",
		LcBulkSubmoduleOptions:              "bulk submodule options",
		LcRunningCommand:                    "실행중인 명령",
		...
		GitCommandFailed:                    "Git 명령 실패. 상세 정보는 명령 로그 참조. (open with %s)",
		AbortTitle:                          "%s 중지",
		...
		ConfirmRevertCommit:        "정말로 {{.selectedCommit}}를 revert 하시겠습니까?",
		RewordInEditorTitle:        "커밋 메시지를 에디터에서 수정",
		RewordInEditorPrompt:       "정말로 이 커밋을 에디터에서 reword 하시겠습니까?",
		HardResetAutostashPrompt:   "Are you sure you want to hard reset to '%s'? An auto-stash will be performed if necessary.",
		CheckoutPrompt:             "정말로 '%s'를 체크아웃 하시겠습니까?",
		...
		Actions: Actions{
			...
			Pull:                              "업데이트(Pull)",
			OpenFile:                          "파일 열기",
			StashAllChanges:                   "모든 변경을 Stash",
			StashAllChangesKeepIndex:          "모든 변경을 Stash하고 index 유지",
			StashStagedChanges:                "Stash staged changes",
			StashUnstagedChanges:              "Stash unstaged changes",
			GitFlowFinish:                     "Git flow finish",
			GitFlowStart:                      "Git Flow start",
			CopyToClipboard:                   "클립보드로 복사",
			CopySelectedTextToClipboard:       "선택한 텍스트를 클립보드로 복사",
